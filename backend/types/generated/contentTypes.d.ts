...
export interface ApiCapabilityCapability extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Portfolio capability categories';
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'WordPress migrated blog categories';
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'WordPress migrated blog post comments';
    displayName: 'Comment';
    pluralName: 'comments';
  ...
  attributes: {
    author_email: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiJobApplicationJobApplication
  ...
  attributes: {
    cover_letter: Schema.Attribute.Text & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email & Schema.Attribute.Required;
    full_name: Schema.Attribute.String & Schema.Attribute.Required;
    job_listing: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiJobListingJobListing extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Open job positions at Del-York Communications';
...
export interface ApiPortfolioPortfolio extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'DYComms Work Portfolio Showcase';
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'WordPress migrated blog articles';
    displayName: 'Post';
    pluralName: 'posts';
    singularName: 'post';
  };
